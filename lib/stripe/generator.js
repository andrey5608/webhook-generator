...
exports.generateStripeEvent = void 0;
var uuid_1 = require("uuid");
var hmac_1 = require("./hmac");
var stripe = require('../stripe/lib/Webhooks.js');
function generateStripeEvent(webhookData) {
    var EVENT_PAYLOAD = {
        'id': webhookData.id,
        'object': 'event',
        ...
        'data': {
            'object': {
                ...
                'charges': {
                    ...
                    'has_more': false,
                    'total_count': 1,
                    'url': "/v1/charges?payment_intent=".concat(webhookData.sessionId)
                },
        ...
        'request': {
            ...
            'idempotency_key': uuid_1.v4,
        },
        'type': webhookData.executionResult ? 'payment_intent.succeeded' : 'payment_intent.payment_failed'
    };
    var EVENT_PAYLOAD_STRING = JSON.stringify(EVENT_PAYLOAD);
    var header = (0, hmac_1.calculateHmacHeader)(EVENT_PAYLOAD_STRING, webhookData.stripeHmacKey);
    var event = stripe.constructEvent(EVENT_PAYLOAD_STRING, header, webhookData.stripeHmacKey);
    return { event: event, header: header };
}
exports.generateStripeEvent = generateStripeEvent;
