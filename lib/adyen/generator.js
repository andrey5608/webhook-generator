...
function generateAdyenEvent(webhookData) {
    ...
    var hmac = hmac_1.calculateHmac(webhookData.adyenHmacKey, webhookData.pspReference, webhookData.originalReference, webhookData.merchantAccountCode, webhookData.merchantReference, webhookData.amountInCents, webhookData.currency, isSuccessful);
    return {
        live: 'false',
        notificationItems: [
            {
